...
export const yellowStations = ["Samaypur Badli",
	"Rohini Sector 18-19",
	"Haiderpur Badli Mor",
	"Jahangirpuri",
	"Adarsh Nagar",
...
export const yellowConnections = [["YELLOW Azadpur", "PINK Azadpur"],
...
export const blueStations = ["Dwarka Sector 21",
	"Dwarka Sector 8",
	"Dwarka Sector 9",
	"Dwarka Sector 10",
	"Dwarka Sector 11",
...
export const blueConnections = [["BLUE Dwarka Sector 21", "AIRPORT Dwarka Sector 21"],
...
export const airportExpressStations = ["New Delhi-Airport Express",
	"Shivaji Stadium",
	"Dhaula Kuan",
	"Delhi Aerocity",
	"IGI Airport",
...
export const airportExpressConnections = [["AIRPORT New Delhi-Airport Express", "YELLOW New Delhi"],
	["AIRPORT Dhaula Kuan", "PINK Durgabai Deshmukh South Campus"],
	["AIRPORT Dwarka Sector 21", "BLUE Dwarka Sector 21"]]

export const greenStations = ["Inderlok",
	"Ashok Park Main",
	"Punjabi Bagh",
	"Shivaji Park",
	"Madipur",
...
export const greenConnections = [["GREEN Inderlok", "RED Inderlok"]]

export const rapidStations = ["Sector 55-66 (Rapid Metro)",
	"Sector 54 Chowk (Rapid Metro)",
	"Sector 53-54 (Rapid Metro)",
	"Sector 42-43 (Rapid Metro)",
	"DLF Phase 1 (Rapid Metro)",
...
export const rapidConnections = [["RAPID Sikandarpur (Rapid Metro)", 'YELLOW Sikandarpur']]

export const violetStations = ["Kashmere Gate",
	"Lal Quila",	
	"Jama Masjid",
	"Delhi Gate",
	"ITO",
...
export const violetConnections = [["VIOLET Kashmere Gate", "YELLOW Kashmere Gate"],
...
export const magentaStations = ["Janak Puri West",
	"Dabri Mor - Janakpuri South",
	"Dashrath Puri",
	"Palam",
	"Sadar Bazaar Cantonment",
...
export const magentaConnections = [["MAGENTA Janak Puri West",  "BLUE Janak Puri West"],
...
export const blue2Stations = ["Yamuna Bank",
	"Laxmi Nagar",
	"Nirman Vihar",
	"Preet Vihar",
	"Karkar Duma",
...
export const blue2Connections = [["BLUE2 Karkar Duma", "PINK Karkar Duma"],
	["BLUE2 Anand Vihar", "PINK Anand Vihar"]]

export const green2Stations = ["Ashok Park Main",
	"Satguru Ram Singh Marg",
	"Kirti Nagar"]

export const green2Connections = [["GREEN2 Kirti Nagar", "BLUE Kirti Nagar"]]

export const aquaStations = ["Noida Sector 51",
	"Noida Sector 50",
	"Noida Sector 76",
	"Noida Sector 101",
	"Noida Sector 81",
...
export const aquaConnections = [["AQUA Noida Sector 51", "BLUE Noida Sector 52"]]

export const grayStations = ["Dwarka",
	"Nangli",
	"Najafgarh"]

export const grayConnections = [["GRAY Dwarka", "BLUE Dwarka"]]